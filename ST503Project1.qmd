...
enroll1 <- my_wrapper("https://www4.stat.ncsu.edu/~online/datasets/EDU01a.csv")

# Run the function on enrollment URL 2
enroll2 <- my_wrapper("https://www4.stat.ncsu.edu/~online/datasets/EDU01b.csv")
```
...
```{r}
#plot.state(noncounty_tibble, "Enrollment Value")
```
