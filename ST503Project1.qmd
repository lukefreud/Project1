...
#### 3. Function for creating a state variable (Step 5)
...
enroll1 <- my_wrapper("https://www4.stat.ncsu.edu/~online/datasets/EDU01a.csv", value = "Enrollment_Data_1")

# Run the function on enrollment URL 2
enroll2 <- my_wrapper("https://www4.stat.ncsu.edu/~online/datasets/EDU01b.csv", value = "Enrollment_Data_2")
```
