...
#### 3. Function for Creating State Variable
```{r}
...
#### 4. Function for creating the division variable of the state
```{r}
...
#### 5. Function for creating two datasets from one and adding division/state variables
...
combine_tibbles <- function (tibble1, tibble2){
  county_tibble <- bind_rows(tibble1[[1]], tibble2[[1]])
  noncounty_tibble <- bind_rows(tibble1[[2]], tibble2[[2]])
